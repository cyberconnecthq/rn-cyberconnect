...
export declare function clearSigningKeyByAddress(
  address: string
): Promise<void>;
export declare function rotateSigningKey(
  address: string
): Promise<CryptoKeyPair>;
export declare function generateSigningKey(
  address: string
): Promise<CryptoKeyPair>;
...
export declare function signWithSigningKey(
  input: string,
  address: string
): Promise<string>;
