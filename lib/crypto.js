...
exports.arrayBuffer2Hex =
  exports.signWithSigningKey =
  exports.getPublicKey =
  exports.getSigningKey =
  exports.hasSigningKey =
  exports.generateSigningKey =
  exports.rotateSigningKey =
  exports.clearSigningKeyByAddress =
  exports.clearSigningKey =
    void 0;
var DB_1 = require("./DB");
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            (0, DB_1.clearByAddr)(constant_1.SIGNKEY_KEY + address),
          ];
        case 1:
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          signingKey = _a.sent();
          (0, DB_1.set)(constant_1.SIGNKEY_KEY + address, signingKey).then();
...
function hasSigningKey(address) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, (0, DB_1.get)(constant_1.SIGNKEY_KEY + address)];
        case 1:
          return [2 /*return*/, _a.sent()];
      }
    });
...
function getPublicKey(address) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, getSigningKey(address)];
        case 1:
          signingKey = _a.sent();
          return [
            4 /*yield*/,
            window.crypto.subtle.exportKey("spki", signingKey.publicKey),
          ];
        case 2:
          exported = _a.sent();
